//this code is a copy from students.js - not part of my MVP
  //the items i know I want from students.js for the purpose of my custome page are:
  // Edit - Delete - Fetch and map list of custom from DB
      //features to add
      //illuminate stars when favorited
      //gray out stars and text when unfavorited
      //don't update the DB until the page is refreshed or nav away [mind changes/errors]
